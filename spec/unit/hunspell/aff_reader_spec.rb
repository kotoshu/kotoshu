...
RSpec.describe 'Unit: Hunspell AFF Reader' do
  describe '#directives' do
    def directive(line, next_lines, **kwargs)
      source = Kotoshu::Readers::StringReader.new(next_lines)
      reader = Kotoshu::Readers::AffReader.new('', **kwargs)
      reader.read_directive(source, line)
    end
    ...
    it 'parses REP directive' do
      ...
      source = Kotoshu::Readers::StringReader.new(aff_content)

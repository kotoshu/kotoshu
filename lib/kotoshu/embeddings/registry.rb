...
#   Kotoshu::Embeddings::Registry.register_model(:my_model, MyCustomModel)
#
# @example Creating from registry
#   model = Kotoshu::Embeddings::Registry.create_model(:my_model, vectors: my_vectors)
#
# @example Listing available implementations
#   Kotoshu::Embeddings::Registry.models.keys  # => [:onnx, :my_model]
#
module Kotoshu
  module Embeddings
    class Registry
    ...
    # Register built-in implementations. Triggering the autoloaded constants
    # (OnnxRuntimeModel, SimilarityEngine, Vocabulary) here ensures the registry
    # is populated the first time Kotoshu::Embeddings::Registry is referenced.
